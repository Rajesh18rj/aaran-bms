<div x-data="{
    ...
    <button title="Share" x-on:click="share()" class="rounded-full p-1 text-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 active:outline-offset-0 dark:text-slate-300 dark:focus-visible:outline-blue-600">
    ...
    <div x-cloak x-show="fallbackModalIsOpen" class="fixed inset-0 z-100 flex items-end justify-center bg-black/30 p-4 pb-8 sm:items-center lg:p-8" role="dialog" aria-labelledby="sharetModalTitle" aria-modal="true" x-on:click.self="fallbackModalIsOpen = false" x-on:keydown.esc.window="fallbackModalIsOpen = false" x-transition.opacity.duration.200ms x-trap.inert.noscroll="fallbackModalIsOpen">
        <div x-show="fallbackModalIsOpen" class="flex w-full max-w-lg flex-col gap-4 rounded-xl border border-slate-300 overflow-hidden bg-white text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300" x-transition:enter="transition delay-100 duration-200 ease-out motion-reduce:transition-opacity" x-transition:enter-end="scale-100 opacity-100" x-transition:enter-start="scale-50 opacity-0">
            ...
            <div class="flex items-center justify-between border-b border-slate-300 bg-slate-100/60 p-4 dark:border-slate-700 dark:bg-slate-900/20">
                <h3 id="sharetModalTitle" class="font-semibold tracking-wide text-black dark:text-white">Share</h3>
            ...
            <div class="flex flex-col gap-8 px-4 py-8">
                ...
                <div class="grid grid-cols-3 gap-6 px-4 sm:grid-cols-5 sm:gap-4">
                    ...
                    <a href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.penguinui.com%2F&text=UI%20Components%20for%20Tailwind%20CSS%20and%20Alpine%20JS" class="flex flex-col items-center justify-center gap-1.5 text-white" target="_blank">
                        ...
                        <span class="whitespace-nowrap text-xs text-slate-700 dark:text-slate-300">X(Twitter)</span>
                    </a>
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.penguinui.com%2F" class="flex flex-col items-center justify-center gap-1.5 text-white" target="_blank">
                        ...
                        <span class="whitespace-nowrap text-xs text-slate-700 dark:text-slate-300">Facebook</span>
                    </a>
                    ...
                    <a href="http://www.reddit.com/submit?url=https%3A%2F%2Fwww.penguinui.com%2F&title=UI%20Components%20for%20Tailwind%20CSS%20and%20Alpine%20JS" class="flex flex-col items-center justify-center gap-1.5 text-white" target="_blank">
                        ...
                        <span class="whitespace-nowrap text-xs text-slate-700 dark:text-slate-300">Reddit</span>
                    </a>
                    ...
                    <a href="http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.penguinui.com%2F&title=UI%20Components%20for%20Tailwind%20CSS%20and%20Alpine%20JS" class="flex flex-col items-center justify-center gap-1.5 text-white" target="_blank">
                        ...
                        <span class="whitespace-nowrap text-xs text-slate-700 dark:text-slate-300">Linkedin</span>
                    </a>
                    ...
                    <a href="mailto:?subject=Check out Penguin UI&body=Check out this cool UI components library http://www.penguinui.com." class="flex flex-col items-center justify-center gap-1.5" target="_blank">
                        <div class="w-fits flex items-center justify-center size-10 rounded-full bg-blue-700 dark:bg-blue-600 p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="size-6 fill-slate-100 dark:fill-slate-100">
                                <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
                                <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
                            </svg>
                        </div>
                        <span class="whitespace-nowrap text-xs text-slate-700 dark:text-slate-300">Email</span>
                    </a>
                </div>
                ...
                <div class="relative px-2">
                    ...
                    <input id="shareLink" type="text" class="w-full bg-slate-100 border border-slate-300 rounded-xl px-2.5 py-2 pr-10 text-sm text-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 disabled:cursor-not-allowed disabled:opacity-75 dark:border-slate-700 dark:bg-slate-900/50 dark:text-slate-300 dark:focus-visible:outline-blue-600" x-ref="shareUrl" x-bind:value="window.location.href" />
                    <button class="absolute right-5 top-1/2 -translate-y-1/2 rounded-full p-1 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 active:outline-offset-0 dark:focus-visible:outline-blue-600" x-on:click="copyUrlToClipboard($refs.shareUrl.value)" x-on:click.away="copiedToClipboard = false">
                        ...
                        <svg x-cloak x-show="copiedToClipboard" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="1.5" aria-hidden="true" class="size-5 stroke-green-600">
