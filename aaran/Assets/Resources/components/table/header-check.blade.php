<th scope="col" class="w-20 border-r border-neutral-300">
    <label for="checkAll" class="flex justify-center items-center cursor-pointer text-neutral-600 dark:text-neutral-300 ">
