   <div class="bg-white rounded-md border-t-2 border-[#845ADF] flex flex-col justify-evenly">
       <div class="flex flex-row justify-between items-center pt-5 px-5">
           <div class="space-y-2">
               ...
               <div class="text-2xl text-[#845ADF] font-semibold">$12345600</div>
           </div>
           <div class="w-16 h-16">
       ...
       <div class="flex flex-row justify-between items-center pb-5 px-5">
           <div class="text-md font-semibold">
               ...
               <div class="text-[#845ADF]">$1234588</div>
           </div>
           <div>
               <button class="text-[#845ADF] text-sm hover:bg-[#efeafb] px-3 py-1 rounded-md font-semibold inline-flex items-center gap-x-2">
                   <span>
                       View All
                   </span>
