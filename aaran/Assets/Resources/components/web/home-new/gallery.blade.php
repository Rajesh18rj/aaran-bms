...
{{--        bg-[#35383C]  --}}
        ...
        {{--            <div class="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center  animate__animated wow animate__bounceInUp"--}}
        ...
        {{--                Here's to the crazy ones</span>--}}
        {{--                </h1>--}}
        {{--            </div>--}}
        {{--        </section>--}}

        <section class=" animate__animated wow animate__bounceInUp" data-wow-duration="2s">
            <div x-data="{
    ...
    " class="w-full h-full select-none">
                <div class="w-full mx-auto duration-1000 delay-300 opacity-0 select-none ease animate-fade-in-view"
                    ...
                    <ul x-ref="gallery" id="gallery" class="grid grid-cols-2 gap-5 lg:grid-cols-6">
                        ...
                        {{--                             src="'../../../../storage/images/{{$row->club_image}}"--}}
