<div>
    ...
    <x-aaran-ui::forms.m-panel>
        ...
        <!-- Table Caption -------------------------------------------------------------------------------------------->
        <x-aaran-ui::table.caption :caption="'Dispatch'">
            {{$list->count()}}
        ...
        <x-aaran-ui::table.form>
            <x-slot:table_header>
                ...
                <x-aaran-ui::table.header-text> Date </x-aaran-ui::table.header-text>
            ...
            <x-slot:table_body>
                @foreach($list as $index=>$row)
                    <x-aaran-ui::table.row>
                        ...
                        <x-aaran-ui::table.cell-text left>{{$row->vdate}}</x-aaran-ui::table.cell-text>
        ...
        <x-aaran-ui::forms.create :id="$vid">
            <x-aaran-ui::input.floating wire:model="vname" label="Name" style="margin-bottom: 1rem" />
