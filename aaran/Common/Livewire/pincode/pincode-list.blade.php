<div>
    <x-slot name="header">Pincode</x-slot>
    <x-aaran-ui::forms.m-panel>
        ...
        <!-- Table Caption -------------------------------------------------------------------------------------------->
        <x-aaran-ui::table.caption :caption="'Pincode'">
            {{$list->count()}}
        ...
        <x-aaran-ui::forms.create :id="$vid">
            <x-aaran-ui::input.floating wire:model="vname" label="Pin Code" />
