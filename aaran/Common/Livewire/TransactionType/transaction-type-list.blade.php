<div>
    <x-slot name="header">Transaction Type</x-slot>
    <x-aaran-ui::forms.m-panel>
        ...
        <!-- Table Caption -------------------------------------------------------------------------------------------->
        <x-aaran-ui::table.caption :caption="'Transaction Type'">
            {{$list->count()}}
        ...
        <x-aaran-ui::forms.create :id="$vid">
            <x-aaran-ui::input.floating wire:model="vname" label="Transaction Type" />
