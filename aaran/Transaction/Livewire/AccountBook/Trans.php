...
//    public mixed $opening_balance = '0';
    ...
    public function mount($id)
    {
        ...
        $this->transId = $this->accountBook->trans_type_id;
//        if ($this->transId == 108) {
...
//        $this->trans_type_name = 108;
    ...
    public function getObj($id)
    {
        if ($id) {
            ...
            $this->trans_type_name = $obj->trans_type_id ? TransactionType::find($obj->trans_type_id)->vname : '';
            $this->opening_bal = $obj->opening_bal;
            $this->mode_id = $obj->mode_id;
            $this->mode_name = $obj->mode_id ? PaymentMode::find($obj->mode_id)->vname : '';
            $this->vdate = $obj->vdate;
            $this->amount = $obj->amount;
            $this->receipt_type_id = $obj->receipttype_id;
            $this->receipt_type_name = $obj->receipttype_id ? ReceiptType::find($obj->receipttype_id)->vname : '';
            $this->remarks = $obj->remarks;
            $this->chq_no = $obj->chq_no;
            $this->chq_date = $obj->chq_date;
            $this->instrument_bank_id = $obj->instrument_bank_id;
            $this->instrument_bank_name = $obj->instrument_bank_id ? Bank::find($obj->instrument_bank_id)->vname : '';
