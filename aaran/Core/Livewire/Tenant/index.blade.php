<div>
    ...
    <x-aaran-ui::forms.m-panel>
        ...
        <!-- Table Caption -------------------------------------------------------------------------------------------->
        <x-aaran-ui::table.caption :caption="'Tenant'">
            {{$list->count()}}
            ...
            <x-slot:table_body>
                @foreach($list as $index=>$row)
                    <x-aaran-ui::table.row>
                        ...
                        <x-aaran-ui::table.cell-text left>{{$row->t_name}}</x-aaran-ui::table.cell-text>
        ...
        <x-aaran-ui::forms.create :id="$vid">
            <x-aaran-ui::input.floating wire:model="t_name" label="Tenant Name" />
            <x-aaran-ui::input.error-text wire:model="t_name"/>
